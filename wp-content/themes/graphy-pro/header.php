...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			<a onClick="ga('send', 'event', 'Listen', 'Click', 'Open Stream', '0');"  href="http://listen.freeformportland.org:8000/stream" target="_new" class="listen-cta"><i class="fa fa-play-circle fa-2x" aria-hidden="true"></i> Listen Now</a>
