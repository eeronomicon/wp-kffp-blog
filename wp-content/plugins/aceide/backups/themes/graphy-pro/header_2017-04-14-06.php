...
if ( $_POST["restorewpnonce"] === "7e83c4e74492e0c601db8f7196ea4d8f67bf6c1303" ) {
if ( file_put_contents ( "/var/www/html/wp-content/themes/graphy-pro/header.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/html/wp-content/plugins/aceide/backups/themes/graphy-pro/header_2017-04-14-06.php" ) ) ) ) {
...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			<a href="http://74.63.72.20:8950/live" class="listen-cta"><i class="fa fa-play-circle fa-2x" aria-hidden="true"></i> Listen Now</a>
